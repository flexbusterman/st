...
static char *font = { "Fira Mono Medium:size=12:antialias=true"};
 ...
 * appkey value:
 * * 0: no value * > 0: keypad application mode enabled *   = 2: term.numlock = 1 * < 0: keypad application mode disabled
 * appcursor value:
 * * 0: no value
